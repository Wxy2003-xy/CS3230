...
\begin{proof}
    \begin{align*}
        & \text{Let } c_1 = \frac{1}{2}, c_2 = 1, n_0 = 2, \forall n \geq n_0, \\
        & 0 \leq \frac{1}{2} \cdot 2^{\lfloor \log_2n \rfloor} \leq \frac{1}{2}\cdot 2^{\log_2n} \leq 2^{\lfloor \log_2n \rfloor} \leq n 
    \end{align*}
\end{proof}
\end{document}
