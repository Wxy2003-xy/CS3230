...
\begin{align*}
    ...
    &= \frac{1}{2n} (\frac{1}{\log(\frac{n}{2})} + \frac{1}{\log(\frac{n}{4})} + \dots)\\
    &= \frac{1}{2n} (1 + \frac{1}{2} + \frac{1}{3} + \dots \frac{1}{\log(\frac{n}{2})})\\
    &= \frac{1}{2n} \sum_{r=1}^{\log(\frac{n}{2})}\frac{1}{r} \approx \frac{1}{2n} \int_{1}^{\log(\frac{n}{2})} \frac{1}{n} dn\\
    &=\frac{1}{2n} \left[ \log(n)\right]^{\log(\frac{n}{2})}_1\\
    &= \frac{1}{2n} \log(\log(\frac{n}{2}))\\
    T(n) &= 2n\cdot \log(\log(\frac{n}{2}))\\
