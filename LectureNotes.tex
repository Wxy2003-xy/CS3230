...
\[T(n) = 4\cdot T(\frac{n}{4}) + \frac{n}{\log(n)}\]
\begin{align*}
    T(n) &= 4\cdot T(\frac{n}{4}) + \frac{n}{\log(n)}\\
    \frac{T(n)}{n^2} &= \frac{T(\frac{n}{4})}{(\frac{n}{2})^2} + \frac{1}{2n\cdot \log(\frac{n}{2})}\\
    \frac{T(\frac{n}{4})}{(\frac{n}{2})^2} &= \frac{T(\frac{n}{16})}{(\frac{n}{4})^2} + \frac{1}{4n\cdot \log(\frac{n}{4})}\\
    &\dots\\
    \frac{T(n)}{n^2} &= \frac{1}{2n\cdot \log(\frac{n}{2})} + \frac{1}{4n\cdot \log(\frac{n}{4})} + \dots (\log_4n \text{ terms})\\
    &= \frac{1}{2n} (\frac{1}{\log(\frac{n}{2})} + \frac{1}{2\log(\frac{n}{4})} + \frac{1}{4\log(\frac{n}{8})}+ \dots)\\
    &= \frac{1}{2n} \left( \sum_{i=1}^{\log(\frac{n}{2})}\sum_{j=1}^{}\right)\\
    &= \frac{1}{2n} \sum_{r=1}^{\log(\frac{n}{4})} \frac{1}{2^r \cdot r} \approx \int_{1}^{\log(\frac{n}{4})} \frac{1}{2^x \cdot x }dx\\
    &=\frac{1}{2n} \left[ \frac{\log(x)}{2^{x+1}}\right]^{\log(\frac{n}{4})}_1\\
    &= \frac{1}{2n} \left( \frac{\log(\log(\frac{n}{2}))}{2^{\log(\frac{n}{2})+1}}\right) = \frac{1}{2n} \cdot \frac{\log(\log(\frac{n}{2}))}{n}\\
    T(n) &= \log(\log(\frac{n}{2}))\\
